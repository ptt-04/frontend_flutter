...
class _EditVoucherDialogState extends State<EditVoucherDialog> {
  ...
  late TextEditingController _maxUsageCountController;
  ...
  void initState() {
    ...
    _discountAmountController = TextEditingController(text: widget.voucher.discountAmount.toString());
    _minimumOrderAmountController = TextEditingController(text: widget.voucher.minimumOrderAmount.toString());
    _maxUsageCountController = TextEditingController(text: widget.voucher.maxUsageCount.toString());
    
    _discountType = widget.voucher.discountType;
    _validFrom = widget.voucher.validFrom;
    _validTo = widget.voucher.validTo;
  }
  ...
  Future<void> _updateVoucher() async {
    ...
    try {
      ...
      final success = await adminProvider.updateVoucher(widget.voucher.id, voucherDto);
